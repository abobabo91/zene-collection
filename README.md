...
|---|---|---|
| **Idővonal** | `genre_timeline` | mikor került be mi, műfajonként, kumulált nézetben — 14 830 bejegyzés, 2004-2026 |
| **Előadó-gráf** | `_local_music_graph` | ki kivel szerepel, 19 terület fülenként, előadóra kattintva a mappafája — 15 153 szám |
...
korábban `15,465 bejegyzés` állt rajta, miközben a katalógusban már csak 14 830 sor volt.
...
`_other/_elektro` fát (**1 216 track a 15 153-ból**) — a többi műfajra még nem futott le a
...
-------
15 153  gráf (data/*/normalized/songs.json összege)
```

A gráfban **egyetlen szám sincs kétszer** (15 153 sor, 15 153 különböző útvonal). Korábban
